...
import com.rebfabric.poc.contact.repository.CompanyRepository;
import com.rebfabric.poc.contact.service.dto.CompanyDTO;
import com.rebfabric.poc.contact.service.mapper.CompanyMapper;
...
class CompanyResourceIT {
    ...
    private static final String DEFAULT_PRIV_TEAM = "AAAAAAAAAA";
    private static final String UPDATED_PRIV_TEAM = "BBBBBBBBBB";
    ...
    public static Company createEntity(EntityManager em) {
        Company company = new Company().name(DEFAULT_NAME).privTeam(DEFAULT_PRIV_TEAM);
        return company;
    }
    ...
    public static Company createUpdatedEntity(EntityManager em) {
        Company company = new Company().name(UPDATED_NAME).privTeam(UPDATED_PRIV_TEAM);
        return company;
    }
    ...
    void createCompany() throws Exception {
        ...
        assertThat(testCompany.getPrivTeam()).isEqualTo(DEFAULT_PRIV_TEAM);
    }
    ...
    void getAllCompanies() throws Exception {
        ...
        restCompanyMockMvc
            ...
            .andExpect(jsonPath("$.[*].privTeam").value(hasItem(DEFAULT_PRIV_TEAM)));
    }
    ...
    void getCompany() throws Exception {
        ...
        restCompanyMockMvc
            ...
            .andExpect(jsonPath("$.privTeam").value(DEFAULT_PRIV_TEAM));
    }
    ...
    void putExistingCompany() throws Exception {
        ...
        updatedCompany.name(UPDATED_NAME).privTeam(UPDATED_PRIV_TEAM);
        ...
        assertThat(testCompany.getPrivTeam()).isEqualTo(UPDATED_PRIV_TEAM);
    }
    ...
    void partialUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.privTeam(UPDATED_PRIV_TEAM);
    ...
    void fullUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.name(UPDATED_NAME).privTeam(UPDATED_PRIV_TEAM);
